...
export default function ImageGenerationSettings({
  ...
  if (!entity) {
    console.error("ImageGenerationSettings: entity is null or undefined");
    return (
      <BasePage
        title="Error"
        description="No entity provided for image generation"
      >
        <div>
          <p>Error: No entity provided for image generation.</p>
  ...
  console.log("ImageGenerationSettings rendered with:", { entity, entityType });
  ...
  function buildImagePrompt() {
        ...
        if (Array.isArray(value)) {
          cleanValue = value
            .map((v) => {
              ...
              return v
                .replace(new RegExp(`${trait}_`, "g"), "")
                .replace(
                  /^(haircolor_|bodytype_|buttsize_|breast_size_|cock_size_|butt_size_|hair_color_|hair_style_|body_type_|notable_features_|eyes_|race_)/g,
                  "",
                )
                .replace(/_/g, " ");
            })
    ...
    const outfitKey =
      selectedOptions.typical_outfit ||
      selectedOptions.outfit ||
      selectedOptions.typicalOutfit;
    if (!settings.outfit && outfitKey) {
      const outfit = outfitKey
        .replace(/typical_outfit_|outfit_|typicalOutfit_/g, "")
        .replace(/_/g, " ");
    ...
    if (settings.expression) {
      const expression = EXPRESSION_OPTIONS.find(
        (e) => e.id === settings.expression,
      );
      if (expression)
        parts.push(`${expression.label.toLowerCase()} expression`);
    }
  ...
  async function enhancePrompt() {
    ...
    try {
      ...
      if (result.success && result.enhancedPrompt) {
        ...
        if (result.isMock) {
          console.log(
            "Note: This is a mock enhancement as the actual API was unavailable",
          );
        }
      } else {
  ...
  if (showBatchResults) {
    const prompt =
      useEnhancedPrompt && enhancedPrompt ? enhancedPrompt : buildImagePrompt();
  ...
  if (currentImage) {
    return (
      <BasePage
        title={`Generated Image - ${entity.label}`}
        description="Review your generated image"
      >
        <div className="image-generation-result">
          <div className="generated-image-display">
            <img
              src={currentImage.url}
              alt={`Generated image for ${entity.label}`}
            />
          </div>
          ...
          <div className="image-actions">
            ...
            <button type="button" onClick={discardCurrentImage}>
              Discard & Retry
            </button>
  ...
  return (
    <BasePage
      title={`Generate Image - ${entity.label}`}
      description={`Create images for ${entityType}: ${entity.label}`}
    >
        ...
        <div className="image-generation-main">
          <section className="entity-summary">
            ...
            <div className="entity-info">
              ...
              {entity.summary && (
                <p>
                  <strong>Description:</strong> {entity.summary}
                </p>
              )}
            </div>
          </section>
            ...
            <div className="prompt-preview">
              ...
              <div className="prompt-content">
                <div className="prompt-text">
                  ...
                  <p>
                    {buildImagePrompt() ||
                      "Select options to see prompt preview..."}
                  </p>
                </div>
                ...
                <div className="prompt-enhancement">
                  <div className="enhancement-header">
                    ...
                    <div className="enhancement-controls">
                      ...
                      >
                        ...
                        <option value="random">
                          Prompt with {"{Random|Curly}"} blocks
                        </option>
                      </select>
                      <button
                        type="button"
                      ...
                      <div className="enhanced-prompt-header">
                        <label>
                          <input
                            ...
                            onChange={(e) =>
                              setUseEnhancedPrompt(e.target.checked)
                            }
                          />
                          Use Enhanced Prompt
                        </label>
                  ...
                  <div className="enhancement-info">
                    <small>
                      ...
                      {enhancedPrompt
                        ? useEnhancedPrompt
                          ? "Enhanced prompt will be used for generation."
