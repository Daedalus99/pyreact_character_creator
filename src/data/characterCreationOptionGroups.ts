...
export const raceOptionGroup : OptionGroup = {
  ...
  options: [
    {
        id: "race_white", displayText: "White",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_black", displayText: "Black",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_asian", displayText: "Asian",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_latina", displayText: "Latina",
        imageUrl: defaultImage, altText: "race"
    },    
    {
        id: "race_indian", displayText: "Indian",
        imageUrl: defaultImage, altText: "race"
    },
        {
        id: "race_middleEastern", displayText: "Middle Eastern",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_demon", displayText: "Demon",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_elf", displayText: "Elf",
        imageUrl: defaultImage, altText: "race"
    },
    {
        id: "race_catgirl", displayText: "Cat Girl",
        imageUrl: defaultImage, altText: "race"
    },
...
export const eyesOptionGroup: OptionGroup = {
  ...
  options: [
    {
      id: "eyes_blue", displayText: "Blue",
      imageUrl: defaultImage, altText: "Blue eyes",
    },
    {
      id: "eyes_brown", displayText: "Brown",
      imageUrl: defaultImage, altText: "Brown eyes",
    },
    {
      id: "eyes_green", displayText: "Green",
      imageUrl: defaultImage, altText: "Green eyes",
    },
    {
      id: "eyes_hazel", displayText: "Hazel",
      imageUrl: defaultImage, altText: "Hazel eyes",
    },
    {
      id: "eyes_gray", displayText: "Gray",
      imageUrl: defaultImage, altText: "Gray eyes",
    },
    {
      id: "eyes_amber", displayText: "Amber",
      imageUrl: defaultImage, altText: "Amber eyes",
    },
    {
      id: "eyes_violet", displayText: "Violet",
      imageUrl: defaultImage, altText: "Violet eyes",
    },
    {
      id: "eyes_red", displayText: "Red",
      imageUrl: defaultImage, altText: "Red eyes",
    },
    {
      id: "eyes_heterochromia", displayText: "Heterochromia",
      imageUrl: defaultImage, altText: "Heterochromia eyes",
    },
  ],
};
...
export const kinksOptionGroup: OptionGroup = {
  ...
  allowCustomOptions: true,
  options: [
    {id: "kinks_breeding", displayText: "Breeding", descriptionText: "Impregnation, creampies, and getting/filling someone pregnant."},
    {id: "kinks_exhibitionism", displayText: "Exhibitionism", descriptionText: "Public sex, being watched, or showing off lewd acts."},
    {id: "kinks_cumflation", displayText: "Cumflation", descriptionText: "Extreme cum inflation and belly bulging from large loads."},
    {id: "kinks_incest", displayText: "Incest", descriptionText: "Taboo family relations and forbidden familial dynamics."},
    {id: "kinks_bondage", displayText: "Bondage", descriptionText: "Restraints, ropes, cuffs, and immobilization play."},
    {id: "kinks_bdsm", displayText: "BDSM", descriptionText: "Dominance, submission, pain, and power exchange."},
    {id: "kinks_anal", displayText: "Anal", descriptionText: "Anal sex, training, and ass-focused play."},
    {id: "kinks_creampie", displayText: "Creampie", descriptionText: "Internal cumshots and messy leaking after filling."},
    {id: "kinks_gangbang", displayText: "Gangbang", descriptionText: "Multiple partners at once, being overwhelmed."},
    {id: "kinks_cnc", displayText: "CNC", descriptionText: "Consensual Non-Consent and ravishment fantasies."},
    {id: "kinks_petplay", displayText: "Petplay", descriptionText: "Animal roleplay, collars, and owner/pet dynamics."},
    {id: "kinks_mindbreak", displayText: "Mind Break", descriptionText: "Overstimulation leading to total submissive breakdown."},
    {id: "kinks_possessive", displayText: "Possessive", descriptionText: "Marking, claiming, and intense ownership."},
    {id: "kinks_roleplay", displayText: "Roleplay", descriptionText: "Acting out specific characters or scenarios."},
  ],
};
